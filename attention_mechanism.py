...
def prepareData(lang1, lang2, reverse=False):
    ...
    # This is for limiting the number of pairs
...
if __name__ == "__main__":
    ...
    print('Input Language mappings: ', input_lang.word2index)
    print('Output Language mappings: ', output_lang.word2index)
    hidden_size = 256
    ...
    # torch.save(encoder1, "pickle_out_encoder")
    # torch.save(attn_decoder1, "pickle_out_decoder")
    # encoder1 = torch.load("pickle_out_encoder")
    # attn_decoder1 = torch.load("pickle_out_decoder")

    while True:
        ask = input("Enter the sentence to translate  and do not close the script!!!!")
        evaluateAndShowAttention(ask)
